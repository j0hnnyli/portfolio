...
const ContactSection = ({sectionRef} : Props) => {
  return (
    <div ref={sectionRef}>
      <h2 className='text-white tracking-widest text-5xl text-center font-bold border-b-2 border-orange-500 leading-[.1rem]'>
        <span style={{backgroundColor: '#3b3b3b'}} className='bg-white py-2 px-4'>
          Contact Me  
        </span>
      </h2>
      ...
      <div className='border-b-2 border-orange-500 relative flex items-center justify-center'>
        <div style={{backgroundColor: '#3b3b3b'}} className='bg-white py-2 px-4 absolute flex items-center -top-5'>
