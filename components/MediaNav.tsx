...
const MediaNav = ({fn, home, about, project, contact} : Props) => {
  return (
    <div style={{backgroundColor: '#3b3b3b'}} className='md:hidden  w-full fixed top-0 flex justify-start items-center z-50'>
      <Sheet>
        <SheetTrigger className='text-orange-500 p-2'>
          <IoMenuOutline className='text-4xl'/>
        </SheetTrigger>

        <SheetContent style={{backgroundColor : '#3b3b3b'}} side='left' className='text-white'>
